...
%o`, message, error2, detail);
  ...
  var chat_scroll_controller_default = class extends Controller {
    connect() {
  ...
  s(g, "targets", ["form", "status"]), s(g, "values", { submitDuration: { type: Number, default: 1e3 }, statusDuration: { type: Number, default: 2e3 }, submittingText: { type: String, default: "Saving..." }, successText: { type: String, default: "Saved!" }, errorText: { type: String, default: "Unable to save." } });
  var m = class extends Controller {
    ...
    _getContrastYIQ(t) {
      ...
      return (a * 299 + i * 587 + d * 114) / 1e3 >= e ? "#000" : "#fff";
    }
  };
  ...
  application.register("room", room_controller_default);
  application.register("form", form_controller_default);
  application.register("chat-scroll", chat_scroll_controller_default);
  application.register("alert", v);
  application.register("autosave", g);
  application.register("color-preview", m);
  application.register("dropdown", n);
  application.register("modal", T);
  application.register("popover", x);
  application.register("slideover", V);
  application.register("tabs", h);
  application.register("toggle", b);
})();
